...
const CreatePin = ({ user }) => {
  ...
  const savePin = () => {
    console.log(title, about, destination, imageAsset, category);
    ...
    <div className="flex flex-row justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className=" flex flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          />
          {user && (
            <div className="flex gap-2 mw-2 items-center bg-white rounded-lg">
              <img
                src={user.image}
            ...
            <div>
              ...
              >
                ...
                {categories.map((category) => (
                  <option className="sm:text-bg bg-white" key={category.name}>
                    {category.name}
                  </option>
                ))}
              </select>
